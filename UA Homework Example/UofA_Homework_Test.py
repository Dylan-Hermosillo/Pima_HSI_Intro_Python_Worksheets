...
from UA_Homework_Example import *

'''
Note: This will only run if the file is name as the line above 'UA_Homework_Example' and if your functions are 
spelled exactly the way they are in the instructions.
'''
